...
@run_on_ui_thread
def toast(text, gravity=0, y=0, x=0, duration: float = 2.5):
    """
    Displays a toast.

    :param duration: the amount of time (in seconds) that the toast is
    ...
    t = Toast.makeText(activity, String(text), int(duration) * 1000)
